...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sqls = "UPDATE sellers SET firstName='$firstName', lastName='$lastName', email='$email', contactNo='$contactNo' WHERE username='$username'";
    if ($conn->query($sqlu) === TRUE && $conn->query($sqls) === TRUE) {
	...
	$sqls = "SELECT * FROM sellers WHERE username='$username'";
